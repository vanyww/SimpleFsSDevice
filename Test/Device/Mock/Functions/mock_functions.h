...
bool TryReadFromMemory(__SDEVICE_HANDLE(FlashFileSystem) *, uintptr_t, FlashFileSystemBlockValue *);
bool TryWriteToMemory(__SDEVICE_HANDLE(FlashFileSystem) *, uintptr_t, const FlashFileSystemBlockValue *);
